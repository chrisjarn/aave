    ...
    return (
      <div className="flex flex-col gap-1.5 w-full">
        ...
        <input
          id={inputId}
          type={type}
          className={`w-full border-none h-11 px-4 bg-bg-3 text-fg-1 text-sm font-normal font-sans leading-prose tracking-normal placeholder:text-fg-3 focus:outline-none focus:ring-2 focus:ring-focus disabled:cursor-not-allowed disabled:opacity-50 transition-shadow duration-150 [font-feature-settings:'cv11'_on,'ss01'_on] ${variantStyles[variant]} ${className ?? ""}`}
          ref={ref}
          {...props}
        />
      </div>
