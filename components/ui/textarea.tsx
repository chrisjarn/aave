    ...
    return (
      <div className="flex flex-col gap-2 w-full">
        ...
        <textarea
          ...
          aria-invalid={!!error}
          className={`w-full min-h-[100px] resize-y rounded-xl border-none bg-bg-3 px-4 py-3 text-sm font-normal text-fg-1 leading-prose tracking-normal placeholder:text-fg-3 focus:outline-none focus:ring-2 focus:ring-focus transition-shadow disabled:cursor-not-allowed disabled:opacity-50 [font-feature-settings:'cv11'_on] ${error ? "ring-1 ring-accent-red focus:ring-accent-red/60" : ""} ${className ?? ""}`}
          {...props}
        />
        {error && (
